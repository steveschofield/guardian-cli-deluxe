...
class ToolAgent(BaseAgent):
    ...
    def __init__(self, config, llm_client, memory):
        ...
        from tools import (
            ...
            KiterunnerTool,
            AmassTool, WhoisTool, WappalyzerTool, HydraTool, JwtTool, GraphqlCopTool, TplmapTool, UploadScannerTool, CsrfTesterTool,
            JsparserTool,
            Enum4linuxTool, SmbclientTool, ShowmountTool, SnmpwalkTool, OnesixtyoneTool, Xprobe2Tool,
